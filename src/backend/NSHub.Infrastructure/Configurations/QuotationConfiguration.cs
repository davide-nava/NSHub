...
public class QuotationConfiguration(IRequestContext requestContext)
    : AuditableTenantEntityConfiguration(requestContext), IEntityTypeConfiguration<Quotation>
{
    public void Configure(EntityTypeBuilder<Quotation> builder)
    {
        _ = builder.ToTable("Quotation", "dbo");

        _ = builder.Property(e => e.QuotationNumber).HasMaxLength(50).IsRequired();
        ...
        _ = builder.Property(e => e.PaymentId).IsRequired();
        ...
        _ = builder.Property(e => e.ValidityDays).IsRequired();
        ...
        _ = builder.Property(e => e.StatusCode).HasMaxLength(30).IsRequired().HasDefaultValueSql("('Pending')");
