...
public class TransportCareDeliveryNoteConfiguration(IRequestContext requestContext)
    : AuditableTenantEntityConfiguration(requestContext), IEntityTypeConfiguration<TransportCareDeliveryNote>
{
    public void Configure(EntityTypeBuilder<TransportCareDeliveryNote> builder)
    {
        _ = builder.ToTable("TransportCareDeliveryNote", "dbo");
