...
public class PlcVariableGroupTypeConfiguration : IEntityTypeConfiguration<PlcVariableGroupType>
{
    public void Configure(EntityTypeBuilder<PlcVariableGroupType> builder)
    {
        builder.ToTable("PlcVariableGroupType", "dbo");
