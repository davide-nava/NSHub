// <copyright file="TicketInterventionConfiguration.cs" company="Davide Nava">
...
public class TicketInterventionConfiguration(IRequestContext requestContext)
    : AuditableTenantEntityConfiguration(requestContext), IEntityTypeConfiguration<TicketIntervention>
{
    public void Configure(EntityTypeBuilder<TicketIntervention> builder)
    {
        _ = builder.ToTable("TicketIntervention", "dbo");
