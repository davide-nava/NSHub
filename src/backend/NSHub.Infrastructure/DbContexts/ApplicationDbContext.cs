    ...
    IdentityDbContext<IdentityUser>(options)
{
    ...
    /// <summary>
    /// Gets the database set for addresses.
    /// </summary>
    public DbSet<Address> Addresses => Set<Address>();


    /// <summary>
    /// Gets the database set for address types.
    /// </summary>
    public DbSet<AddressType> AddressTypes => Set<AddressType>();


    /// <summary>
    /// Gets the database set for agreement types.
    /// </summary>
    public DbSet<AgreementType> AgreementTypes => Set<AgreementType>();


    /// <summary>
    /// Gets the database set for articles.
    /// </summary>
    public DbSet<Article> Articles => Set<Article>();

/// <summary>
/// Gets the database set for article brands.
/// </summary>
    public DbSet<ArticleBrand> ArticleBrands => Set<ArticleBrand>();

/// <summary>
/// Gets the database set for article categories.
/// </summary>
    public DbSet<ArticleCategory> ArticleCategories => Set<ArticleCategory>();


/// <summary>
/// Gets the database set for article category mappings.
/// </summary>
    public DbSet<ArticleCategoryMap> ArticleCategoryMaps => Set<ArticleCategoryMap>();


/// <summary>
/// Gets the database set for article groups.
/// </summary>
    ...
    /// <summary>
    /// Gets the database set for warehouse organizations.
    /// </summary>
