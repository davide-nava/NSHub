// <copyright file="SwissWorktimePolicy.cs" company="Davide Nava">
// Copyright (c) Davide Nava. All rights reserved.
// </copyright>

using NSHub.Domain.Enums;

namespace NSHub.Domain.Services;
...
/// <summary>
/// Breakdown of worked hours under Swiss labor law, distinguishing ordinary hours, supplementary hours (Überstunden), and statutory overtime (Überzeit).
/// </summary>
/// <param name="TotalWorkedHours">Total recorded working hours.</param>
/// <param name="OrdinaryHours">Ordinary contractual working hours.</param>
/// <param name="SupplementaryHours">Supplementary overtime hours exceeding contractual hours up to the statutory limit (CO art. 321c).</param>
/// <param name="StatutoryOvertimeHours">Statutory overtime hours exceeding the maximum legal weekly limit (LL art. 12/13).</param>
public record WorktimeBreakdown(
    decimal TotalWorkedHours,
    decimal OrdinaryHours,
    decimal SupplementaryHours,
    decimal StatutoryOvertimeHours
);
