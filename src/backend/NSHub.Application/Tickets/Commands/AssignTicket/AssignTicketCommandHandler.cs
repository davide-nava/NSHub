// <copyright file="AssignTicketCommandHandler.cs" company="Davide Nava">
...
public sealed class AssignTicketCommandHandler(
    ...
    IUnitOfWork unitOfWork) : IRequestHandler<AssignTicketCommand, Result<TicketDto>>
{
    public async Task<Result<TicketDto>> Handle(AssignTicketCommand request, CancellationToken cancellationToken)
    {
        ...
        ticket.AssignTechnician(request.TechnicianId);
